...
2. **Unofficial.** The app is independent and not affiliated with, endorsed or sponsored by the CTS or the Eurométropole de Strasbourg.
3. **Ads.** A banner is shown on the home screen (see the Privacy Policy).
4. **Tips.** Tips are voluntary gifts made through Google Play. They unlock no gameplay advantage; they only remove the banner and show a heart. Refunds follow Google Play's policy.
...
2. **Non officielle.** L'application est indépendante et sans lien avec la CTS ni l'Eurométropole de Strasbourg.
3. **Publicité.** Une bannière est affichée sur l'accueil (voir la Politique de confidentialité).
4. **Pourboires.** Volontaires, via Google Play. Ils ne donnent aucun avantage de jeu : ils retirent seulement la bannière et affichent un cœur. Remboursements selon la politique de Google Play.
