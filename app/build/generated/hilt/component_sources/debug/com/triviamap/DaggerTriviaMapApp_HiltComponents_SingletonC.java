...
import com.triviamap.presentation.gameplay.GameplayViewModel;
...
public final class DaggerTriviaMapApp_HiltComponents_SingletonC {
  private DaggerTriviaMapApp_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public TriviaMapApp_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements TriviaMapApp_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public TriviaMapApp_HiltComponents.ActivityRetainedC build() {
      Preconditions.checkBuilderRequirement(savedStateHandleHolder, SavedStateHandleHolder.class);
      return new ActivityRetainedCImpl(singletonCImpl, savedStateHandleHolder);
    }
  }

  private static final class ActivityCBuilder implements TriviaMapApp_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public TriviaMapApp_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements TriviaMapApp_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public TriviaMapApp_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements TriviaMapApp_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public TriviaMapApp_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements TriviaMapApp_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public TriviaMapApp_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements TriviaMapApp_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public TriviaMapApp_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements TriviaMapApp_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public TriviaMapApp_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends TriviaMapApp_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends TriviaMapApp_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends TriviaMapApp_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends TriviaMapApp_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
    ...
    private MainActivity injectMainActivity2(MainActivity instance) {
      MainActivity_MembersInjector.injectTramLineRepository(instance, singletonCImpl.tramLineRepositoryImplProvider.get());
      return instance;
    }
  ...
  private static final class ViewModelCImpl extends TriviaMapApp_HiltComponents.ViewModelC {
    ...
    private GetAllLinesUseCase getAllLinesUseCase() {
      return new GetAllLinesUseCase(singletonCImpl.tramLineRepositoryImplProvider.get());
    }

    private SaveGameResultUseCase saveGameResultUseCase() {
      return new SaveGameResultUseCase(singletonCImpl.gameResultRepositoryImplProvider.get());
    }

    private GetBestScoresUseCase getBestScoresUseCase() {
      return new GetBestScoresUseCase(singletonCImpl.gameResultRepositoryImplProvider.get());
    }
  ...
  private static final class ActivityRetainedCImpl extends TriviaMapApp_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends TriviaMapApp_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class SingletonCImpl extends TriviaMapApp_HiltComponents.SingletonC {
    private final ApplicationContextModule applicationContextModule;

    private final SingletonCImpl singletonCImpl = this;

    private Provider<TramLineRepositoryImpl> tramLineRepositoryImplProvider;

    private Provider<TriviaMapDatabase> provideDatabaseProvider;
    ...
    private GameResultDao gameResultDao() {
      return DatabaseModule_ProvideGameResultDaoFactory.provideGameResultDao(provideDatabaseProvider.get());
    }
    ...
    @Override
    public void injectTriviaMapApp(TriviaMapApp triviaMapApp) {
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.triviamap.data.repository.TramLineRepositoryImpl 
          return (T) new TramLineRepositoryImpl(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 1: // com.triviamap.data.repository.GameResultRepositoryImpl 
          return (T) new GameResultRepositoryImpl(singletonCImpl.gameResultDao());
